...
TUTO ČÁST MUSÍM JEŠTĚ ZNAČNĚ VYLEPŠIT, KOUKAL JSEM SE NA DATA, NENAŠEL JSEM CHYBU, ZKUSÍM PŘEPOČÍTAT PRŮMĚRY JEŠTĚ JEDNOU:
...
\begin{figure}[]
	\centering
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_ibu_s_20_2.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_ibu_s_20_2_r2.png}}\\
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_nap_2_31.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_nap_2_31_r2.png}}\\
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_cbz_2_27.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_cbz_2_27_r2.png}}\\
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_indo_2_36.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_indo_2_36_r2.png}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_ibu_s_20_6.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_ibu_s_20_6_r2.png}}\\
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_nap_6_31.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_nap_6_31_r2.png}}\\
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_cbz_6_27.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_cbz_6_27_r2.png}}\\
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_indo_36_6.png}}
	\subfloat{\includegraphics[width=0.4\linewidth]{img/RDF_indo_36_6_r2.png}}
...
The glass transition temperatures of the systems with the lowest API concentration were also calculated from simulated annealing simulation using the hyperbolic fit described in the methodology. The resulting value for carbamazepine is $T_{\text{g, cbz}} = 385 \pm 4$ (k = 2) and for naproxen is $T_{\text{g, nap}} = 365 \pm 2$ (k = 2). As I described above, the standard deviation is underestimated.
